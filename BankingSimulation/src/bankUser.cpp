...
// bool BankUser::findStatement( Transaction &transaction, int accountNumber)
// {
//     bool found = false;
...
//     return found;
// }
// int BankUser::getMiniBankStatement( )
// {
//     InputValidator inputValidator;
//     int accountNumber;
